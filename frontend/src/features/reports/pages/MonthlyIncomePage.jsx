          ...
          {!loading && (
            <>
              <div className="row g-3 mb-4">
                {[['Ventas del mes', safeIncome.grossIncome, 'primary'], ['Gastos del mes', safeIncome.totalExpenses, 'warning'], ['Resultado neto', safeIncome.netResult, safeIncome.netResult >= 0 ? 'success' : 'danger']].map(([label, value, color]) => (
              ...
              <div className="row g-4 align-items-stretch">
                ...
                <h5 className="text-center mb-2">Ventas y gastos del mes</h5>
              ...
              {/* Información detallada */}
                <div className="col-md-6">
                  ...
                  <div className="d-flex justify-content-between border-bottom py-2">
                    <h6 className="fw-bold">Gastos del mes:</h6>
                    <p className="fw-bold text-warning mb-0">{formatCurrency(safeIncome.totalExpenses)}</p>
                  </div>
                  <p className="text-muted">Total de gastos registrados en el mes.</p>
                  ...
                  <p className="text-muted">Ventas realizadas menos gastos del mes.</p>
